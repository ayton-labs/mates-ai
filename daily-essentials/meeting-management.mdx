...
- Zoom-specific AI notetaker
- Automatically joins and records meetings
- Creates highlight reels of key moments
- CRM integration (Salesforce, HubSpot)
- **Free for individuals** (incredibly generous)
- Perfect for: Sales calls, client meetings, demos

**Otter.ai** (Best all-around)
- Works with Zoom, Teams, Google Meet, in-person
- Real-time transcription with speaker identification
- Automatic summary and action items
- Free: 300 min/month | Pro: $17/month
- Perfect for: Team meetings, interviews, general use

**Granola** (Best for augmented note-taking)
- Combines your manual notes with AI enhancement
- Less intrusive than full AI notetakers
- AI fills in gaps from what you typed
- Mac app that works seamlessly
- Perfect for: People who prefer taking their own notes but want AI backup

**How to use:**
1. Set up your preferred tool (Fathom/Otter/Granola) before meeting
2. Let it auto-join or start recording
3. Speak naturally (don't worry about the AI)
4. After meeting, review transcript/notes
5. Export to ChatGPT or Claude for deeper analysis

**Pro tip**: Use Fathom for client calls (free + CRM sync), Otter for team meetings, Granola if you like manual note-taking.
...
Download from Fathom/Otter/Granola as text or upload the recording.

- **Fathom**: Automatically generates summary + transcript
- **Otter**: Click "Export" to get full transcript
- **Granola**: Export your enhanced notes as text
...
2. Get transcript
3. Process with AI to organise ideas

**Prompt:**
```
This is a transcript from a brainstorming session about [topic].

Please organise the ideas discussed:
...
2. **During meeting**: Use Fathom (sales/client) or Otter (team) or Granola (hybrid) to record
3. **After meeting**: Export transcript and use the master meeting processing prompt
...
1. **Choose your tool**:
   - Fathom (free) for sales/client calls
   - Otter.ai (free 300 min/month) for team meetings
   - Granola if you like manual notes + AI
2. **Record your next meeting**
3. **Export the transcript**
4. **Try the master meeting processing prompt**
5. **Send AI-generated follow-up**
6. **Notice the time saved and clarity gained**
7. **Check out [Meeting Management Prompts](../prompts/operations-admin)** for more ready-to-use prompts

**Tool comparison**: See detailed reviews in [Essential AI Tools Directory](../tools/specialized-ai-tools#meeting-transcription)
