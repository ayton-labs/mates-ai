...
---
  ...
  <img src="https://res.cloudinary.com/dqv6k4ijy/image/upload/v1760967549/ChatGPT_Image_Oct_20_2025_02_39_00_PM_dwvzzj.png" alt="Prompt Writing Guide" style={{width: '60%', maxWidth: '600px'}} />
</div>
...
## Browse by Use Case
  ...
  - **[Email & Communication](./email-communication)** - 20+ prompts for emails, responses, and professional communication
  - **[Document Processing](./document-processing)** - 15+ prompts for summaries, extraction, and document analysis
  - **[Data Analysis](./data-analysis)** - 15+ prompts for sales data, trends, and Excel help
  - **[Content Creation](./content-creation)** - 15+ prompts for presentations, proposals, and reports
  - **[Operations & Admin](./operations-admin)** - 15+ prompts for processes, hiring, and task management
...
### Method 3: Notes App
Keep a "AI Prompts" note with your favourites.
...
5. **Share** your favourites with colleagues
