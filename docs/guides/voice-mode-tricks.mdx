...
Press the Voice Mode button in ChatGPT and speak to it like a colleague.
  ...
  <img src="https://res.cloudinary.com/dqv6k4ijy/image/upload/v1760690061/Screenshot_2025-10-17_at_09.33.55_usvshm.png" alt="Voice Mode button in ChatGPT" style={{width: '60%', maxWidth: '600px'}} />
</div>
